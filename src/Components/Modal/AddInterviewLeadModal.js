...
const AddInterviewLeadModal = ({addInterviewLeadModal,setAddInterviewLeadModal}) => {
  const dispatch = useDispatch();
  const navigate = useNavigate();
  const handleClose = () =>{
    setAddInterviewLeadModal(false)
  }
  const obj = [
...
export default AddInterviewLeadModal;
